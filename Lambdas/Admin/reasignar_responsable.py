...
def lambda_handler(event, context):
    try:
        ...
        nuevo_responsableId = body.get('responsableId')
        if not codigo_incidente or not nuevo_responsableId:
        ...
        table.update_item(
            ...
            ExpressionAttributeValues={':r': nuevo_responsableId}
        )
        ...
        historial = {
            ...
            'detalles': f'Responsable reasignado: {nuevo_responsableId}'
        }
        dynamodb.Table(HISTORIAL_TABLE).put_item(Item=historial)
        return response(200, {'codigo_incidente': codigo_incidente, 'responsableId': nuevo_responsableId})
